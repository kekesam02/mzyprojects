...
import com.mzy.service.OrderServiceZookeeperLockImpl;

public class ZookeeperTestOrderShareLock {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < threadcount; i++) {
			new Thread(new Runnable() {
				...
				OrderService orderService = new OrderServiceZookeeperLockImpl();
				@Override
				public void run() {
